...
const ContactSection = () => {
  ...
  return (
    <section id="contato" className="py-14 sm:py-18 md:py-24 bg-background">
      <div className="container mx-auto px-5 sm:px-6">
        ...
        <div ref={content.ref} className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          ...
          {/* Contact Info */}
          <div className={`bg-card rounded-2xl p-6 sm:p-8 flex flex-col justify-center space-y-5 shadow-lg transition-all duration-700 ${content.isVisible ? "animate-slide-right" : "opacity-0"}`}>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-secondary text-secondary-foreground px-6 py-3.5 rounded-full font-bold text-sm hover:brightness-110 hover:scale-105 transition-all duration-200 shadow-lg mt-2"
            >
