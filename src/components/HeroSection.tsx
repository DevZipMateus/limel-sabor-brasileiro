    ...
    >
      ...
      <div className="container mx-auto px-5 sm:px-6 relative z-10">
        <div className="max-w-2xl">
          <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-36 md:h-36 mb-4 md:mb-6 rounded-full bg-white flex items-center justify-center shadow-2xl animate-scale-up animate-float">
            <img
              src={logo}
